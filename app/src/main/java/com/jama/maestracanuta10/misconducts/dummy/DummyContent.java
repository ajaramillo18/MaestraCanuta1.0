package com.jama.maestracanuta10.misconducts.dummy;
...
public class DummyContent {
    ...
    public static List<Misconduct> misconductList = db.getAllMisconducts();

    private static  int COUNT = db.getMisconductsCount();
    ...
    private static DummyItem createDummyItem(int position) {
        Misconduct mc = misconductList.get(position);
        return new DummyItem(mc.getId(), mc.getName(),"tipo: " +mc.getType());
    }
